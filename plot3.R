...
## This script produces a .png file containing a line plot of the 3
## sub-metering records for this household for 1-Feb-2007 and 2-Feb-2007
...
points(hpcdata$DateTime, hpcdata$Sub_metering_2, type = "l", col = "red")
points(hpcdata$DateTime, hpcdata$Sub_metering_3, type = "l", col = "blue")
